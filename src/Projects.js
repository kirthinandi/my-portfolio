...
import project2pic from './phase2project.png';
import project3pic from './phase3project.png';
import finalProjectPic from './finalproject.png';
            ...
            <h2>Some Projects I've Worked On!</h2>
                <div className='card'>
                    <div className='container'>
                        ...
                        <img className="projectpic" src={finalProjectPic} alt="SKINATIC Picture"/>
                    ...
                    <div className='container'>
                        ...
                        <img className="projectpic" src={project3pic} alt="Rory's Online Diary Picture"/>
                    ...
                    <div className='container'>
                        ...
                        <img className="projectpic" src={project2pic} alt="Rick & Morty Hub Picture"/>
                        <p>React   CSS   HTML</p>
                    </div>
                </div>
